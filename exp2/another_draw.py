...
# 要加载的文件名（可修改）
file_names = [
    "TD3_HalfCheetah-v5_0_1.npy",
    "TD3_HalfCheetah-v5_0_2.npy",
    "TD3_HalfCheetah-v5_0_3.npy",
    "TD3_HalfCheetah-v5_0_4.npy",
]
# 每条曲线的标签（图例用）
...
# 图像标题与标签
plt.title("Training with Conditional Policy Transfer in 4 different Environments", fontsize=16, fontweight='bold')
