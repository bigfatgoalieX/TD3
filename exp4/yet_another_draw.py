...
file_paths = [
    "../exp1/results/TD3_HalfCheetah-v5_0_dr_3.npy",  # 对应 parameter_dimension=3
    "results/TD3_HalfCheetah-v5_0_highdim_dr_1.npy",  # 对应 parameter_dimension=10
]
...
# 图像标题与轴标签
plt.title("Training with Domain Randomization while Parameter Dimension Changes", fontsize=16, fontweight='bold')
